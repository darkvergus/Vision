...
std::pair<std::string, std::string> VisionEditor::Resources::RawShaders::GetGrid()
{
...
std::pair<std::string, std::string> VisionEditor::Resources::RawShaders::GetGizmo()
{
	std::pair<std::string, std::string> source;
...
std::pair<std::string, std::string> VisionEditor::Resources::RawShaders::GetBillboard()
{
	std::pair<std::string, std::string> source;
