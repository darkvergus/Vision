...
namespace VisionCore::ECS::Components
{
	...
	*/
	...
	{
	public:
		using MaterialList = std::array<VisionCore::Resources::Material*, MAX_MATERIAL_COUNT>;
		using MaterialField = std::array<std::array<VisionUI::Widgets::AWidget*, 3>, MAX_MATERIAL_COUNT>;
		...
		* @param p_material
		*/
		void FillWithMaterial(VisionCore::Resources::Material& p_material);
		...
		* @param p_material
		*/
		void SetMaterialAtIndex(uint8_t p_index, VisionCore::Resources::Material& p_material);

		/**
		* Returns the material to use at index
		* @param p_index
		*/
		VisionCore::Resources::Material* GetMaterialAtIndex(uint8_t p_index);
		...
		* @param p_instance
		*/
		void RemoveMaterialByInstance(VisionCore::Resources::Material& p_instance);
		...
		*/
		const VisionMaths::FMatrix4& GetUserMatrix() const;
	...
	private:
		...
		VisionMaths::FMatrix4 m_userMatrix;
	};
}