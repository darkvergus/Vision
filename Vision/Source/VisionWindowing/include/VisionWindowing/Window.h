...
#include "VisionWindowing/Settings/WindowSettings.h"
#include "VisionWindowing/Cursor/ECursorShape.h"
#include "VisionWindowing/Cursor/ECursorMode.h"

namespace VisionWindowing
{
	/**
	...
	*/
	...
	public:
		/* Inputs relatives */
		VisionTools::Eventing::Event<int> KeyPressedEvent;
		VisionTools::Eventing::Event<int> KeyReleasedEvent;
		VisionTools::Eventing::Event<int> MouseButtonPressedEvent;
		VisionTools::Eventing::Event<int> MouseButtonReleasedEvent;

		/* Window events */
		VisionTools::Eventing::Event<uint16_t, uint16_t> ResizeEvent;
		VisionTools::Eventing::Event<uint16_t, uint16_t> FramebufferResizeEvent;
		VisionTools::Eventing::Event<int16_t, int16_t> MoveEvent;
		VisionTools::Eventing::Event<int16_t, int16_t> CursorMoveEvent;
		VisionTools::Eventing::Event<> MinimizeEvent;
		VisionTools::Eventing::Event<> MaximizeEvent;
		VisionTools::Eventing::Event<> GainFocusEvent;
		VisionTools::Eventing::Event<> LostFocusEvent;
