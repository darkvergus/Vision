...
#include "VisionWindowing/Context/EDeviceError.h"
#include "VisionWindowing/Settings/DeviceSettings.h"
#include "VisionWindowing/Cursor/ECursorShape.h"

namespace VisionWindowing::Context
{
	/**
	...
	*/
	...
	public:
		...
		*/
		static VisionTools::Eventing::Event<EDeviceError, std::string> ErrorEvent;
