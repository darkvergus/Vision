...
#include "VisionRendering/Settings/ERenderingCapability.h"
#include "VisionRendering/Settings/EPrimitiveMode.h"
#include "VisionRendering/Settings/ERasterizationMode.h"
#include "VisionRendering/Settings/EComparaisonAlgorithm.h"
#include "VisionRendering/Settings/EOperation.h"
#include "VisionRendering/Settings/ECullFace.h"
#include "VisionRendering/Settings/ECullingOptions.h"
#include "VisionRendering/Settings/EPixelDataFormat.h"
#include "VisionRendering/Settings/EPixelDataType.h"
...
namespace VisionRendering::Core
{
	...
	*/
	...
	public:
		...
		* @param p_stencilBuffer
		*/
		void Clear(VisionRendering::LowRenderer::Camera& p_camera, bool p_colorBuffer = true, bool p_depthBuffer = true, bool p_stencilBuffer = true);
		...
		*/
		std::vector<std::reference_wrapper<VisionRendering::Resources::Mesh>> GetMeshesInFrustum
		(
