...
std::unordered_map<GLFWwindow*, VisionWindowing::Window*> VisionWindowing::Window::__WINDOWS_MAP;

VisionWindowing::Window::Window(const Context::Device& p_device, const Settings::WindowSettings& p_windowSettings) :
	m_device(p_device),
...
VisionWindowing::Window::~Window()
{
	glfwDestroyWindow(m_glfwWindow);
}

void VisionWindowing::Window::SetIcon(const std::string & p_filePath)
{
	GLFWimage images[1];
...
void VisionWindowing::Window::SetIconFromMemory(uint8_t* p_data, uint32_t p_width, uint32_t p_height)
{
	GLFWimage images[1];
...
VisionWindowing::Window* VisionWindowing::Window::FindInstance(GLFWwindow* p_glfwWindow)
{
	return __WINDOWS_MAP.find(p_glfwWindow) != __WINDOWS_MAP.end() ? __WINDOWS_MAP[p_glfwWindow] : nullptr;
}

void VisionWindowing::Window::SetSize(uint16_t p_width, uint16_t p_height)
{
	glfwSetWindowSize(m_glfwWindow, static_cast<int>(p_width), static_cast<int>(p_height));
}

void VisionWindowing::Window::SetMinimumSize(int16_t p_minimumWidth, int16_t p_minimumHeight)
{
...
void VisionWindowing::Window::SetMaximumSize(int16_t p_maximumWidth, int16_t p_maximumHeight)
{
...
void VisionWindowing::Window::SetPosition(int16_t p_x, int16_t p_y)
{
	glfwSetWindowPos(m_glfwWindow, static_cast<int>(p_x), static_cast<int>(p_y));
}

void VisionWindowing::Window::Minimize() const
{
	glfwIconifyWindow(m_glfwWindow);
}

void VisionWindowing::Window::Maximize() const
{
	glfwMaximizeWindow(m_glfwWindow);
}

void VisionWindowing::Window::Restore() const
{
	glfwRestoreWindow(m_glfwWindow);
}

void VisionWindowing::Window::Hide() const
{
	glfwHideWindow(m_glfwWindow);
}

void VisionWindowing::Window::Show() const
{
	glfwShowWindow(m_glfwWindow);
}

void VisionWindowing::Window::Focus() const
{
	glfwFocusWindow(m_glfwWindow);
}

void VisionWindowing::Window::SetShouldClose(bool p_value) const
{
	glfwSetWindowShouldClose(m_glfwWindow, p_value);
}

bool VisionWindowing::Window::ShouldClose() const
{
	return glfwWindowShouldClose(m_glfwWindow);
}

void VisionWindowing::Window::SetFullscreen(bool p_value)
{
	if (p_value)
		m_fullscreen = true;
...
void VisionWindowing::Window::ToggleFullscreen()
{
	SetFullscreen(!m_fullscreen);
}

bool VisionWindowing::Window::IsFullscreen() const
{
	return m_fullscreen;
}

bool VisionWindowing::Window::IsHidden() const
{
	return glfwGetWindowAttrib(m_glfwWindow, GLFW_VISIBLE) == GLFW_FALSE;
}

bool VisionWindowing::Window::IsVisible() const
{
	return glfwGetWindowAttrib(m_glfwWindow, GLFW_VISIBLE) == GLFW_TRUE;
}

bool VisionWindowing::Window::IsMaximized() const
{
	return glfwGetWindowAttrib(m_glfwWindow, GLFW_MAXIMIZED) == GLFW_TRUE;
}

bool VisionWindowing::Window::IsMinimized() const
{
	return glfwGetWindowAttrib(m_glfwWindow, GLFW_MAXIMIZED) == GLFW_FALSE;
}

bool VisionWindowing::Window::IsFocused() const
{
	return glfwGetWindowAttrib(m_glfwWindow, GLFW_FOCUSED) == GLFW_TRUE;
}

bool VisionWindowing::Window::IsResizable() const
{
	return glfwGetWindowAttrib(m_glfwWindow, GLFW_RESIZABLE) == GLFW_TRUE;
}

bool VisionWindowing::Window::IsDecorated() const
{
	return glfwGetWindowAttrib(m_glfwWindow, GLFW_DECORATED) == GLFW_TRUE;;
}

void VisionWindowing::Window::MakeCurrentContext() const
{
	glfwMakeContextCurrent(m_glfwWindow);
}

void VisionWindowing::Window::SwapBuffers() const
{
	glfwSwapBuffers(m_glfwWindow);
}

void VisionWindowing::Window::SetCursorMode(Cursor::ECursorMode p_cursorMode)
{
	m_cursorMode = p_cursorMode;
	glfwSetInputMode(m_glfwWindow, GLFW_CURSOR, static_cast<int>(p_cursorMode));
}

void VisionWindowing::Window::SetCursorShape(Cursor::ECursorShape p_cursorShape)
{
	m_cursorShape = p_cursorShape;
	glfwSetCursor(m_glfwWindow, m_device.GetCursorInstance(p_cursorShape));
}

void VisionWindowing::Window::SetCursorPosition(int16_t p_x, int16_t p_y)
{
	glfwSetCursorPos(m_glfwWindow, static_cast<double>(p_x), static_cast<double>(p_y));
}

void VisionWindowing::Window::SetTitle(const std::string& p_title)
{
	m_title = p_title;
	glfwSetWindowTitle(m_glfwWindow, p_title.c_str());
}

void VisionWindowing::Window::SetRefreshRate(int32_t p_refreshRate)
{
	m_refreshRate = p_refreshRate;
}

std::string VisionWindowing::Window::GetTitle() const
{
	return m_title;
}

std::pair<uint16_t, uint16_t> VisionWindowing::Window::GetSize() const
{
	int width, height;
...
std::pair<int16_t, int16_t> VisionWindowing::Window::GetMinimumSize() const
{
	return m_minimumSize;
}

std::pair<int16_t, int16_t> VisionWindowing::Window::GetMaximumSize() const
{
	return m_maximumSize;
}

std::pair<int16_t, int16_t> VisionWindowing::Window::GetPosition() const
{
	int x, y;
...
std::pair<uint16_t, uint16_t> VisionWindowing::Window::GetFramebufferSize() const
{
	int width, height;
...
VisionWindowing::Cursor::ECursorMode VisionWindowing::Window::GetCursorMode() const
{
	return m_cursorMode;
}

VisionWindowing::Cursor::ECursorShape VisionWindowing::Window::GetCursorShape() const
{
	return m_cursorShape;
}

int32_t VisionWindowing::Window::GetRefreshRate() const
{
	return m_refreshRate;
}

GLFWwindow* VisionWindowing::Window::GetGlfwWindow() const
{
	return m_glfwWindow;
}

void VisionWindowing::Window::CreateGlfwWindow(const Settings::WindowSettings& p_windowSettings)
{
...
void VisionWindowing::Window::BindKeyCallback() const
{
...
void VisionWindowing::Window::BindMouseCallback() const
{
...
void VisionWindowing::Window::BindResizeCallback() const
{
...
void VisionWindowing::Window::BindFramebufferResizeCallback() const
{
...
void VisionWindowing::Window::BindCursorMoveCallback() const
{
...
void VisionWindowing::Window::BindMoveCallback() const
{
...
void VisionWindowing::Window::BindIconifyCallback() const
{
...
void VisionWindowing::Window::BindFocusCallback() const
{
...
void VisionWindowing::Window::BindCloseCallback() const
{
...
void VisionWindowing::Window::OnResize(uint16_t p_width, uint16_t p_height)
{
	m_size.first = p_width;
	m_size.second = p_height;
}

void VisionWindowing::Window::OnMove(int16_t p_x, int16_t p_y)
{
	if (!m_fullscreen)
	{
...
void VisionWindowing::Window::UpdateSizeLimit() const
{
