...
float VisionAnalytics::Hardware::CPUInfo::CalculateCPULoad()
{
...
float VisionAnalytics::Hardware::CPUInfo::CalculateCPULoad(uint64_t p_idleTicks, uint64_t p_totalTicks)
{
...
uint64_t VisionAnalytics::Hardware::CPUInfo::FileTimeToInt64(const FILETIME& ft)
{
