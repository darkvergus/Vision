...
VisionRendering::Resources::Texture* VisionRendering::Resources::Loaders::TextureLoader::Create(const std::string& p_filepath, VisionRendering::Settings::ETextureFilteringMode p_firstFilter, VisionRendering::Settings::ETextureFilteringMode p_secondFilter, bool p_generateMipmap)
{
	GLuint textureID;
	int textureWidth;
	int textureHeight;
...
VisionRendering::Resources::Texture* VisionRendering::Resources::Loaders::TextureLoader::CreateColor(uint32_t p_data, VisionRendering::Settings::ETextureFilteringMode p_firstFilter, VisionRendering::Settings::ETextureFilteringMode p_secondFilter, bool p_generateMipmap)
{
	GLuint textureID;
	glGenTextures(1, &textureID);
	glBindTexture(GL_TEXTURE_2D, textureID);
...
VisionRendering::Resources::Texture* VisionRendering::Resources::Loaders::TextureLoader::CreateFromMemory(uint8_t* p_data, uint32_t p_width, uint32_t p_height, VisionRendering::Settings::ETextureFilteringMode p_firstFilter, VisionRendering::Settings::ETextureFilteringMode p_secondFilter, bool p_generateMipmap)
{
	GLuint textureID;
	glGenTextures(1, &textureID);
	glBindTexture(GL_TEXTURE_2D, textureID);
...
void VisionRendering::Resources::Loaders::TextureLoader::Reload(Texture& p_texture, const std::string& p_filePath, VisionRendering::Settings::ETextureFilteringMode p_firstFilter, VisionRendering::Settings::ETextureFilteringMode p_secondFilter, bool p_generateMipmap)
{
...
bool VisionRendering::Resources::Loaders::TextureLoader::Destroy(Texture*& p_textureInstance)
{
