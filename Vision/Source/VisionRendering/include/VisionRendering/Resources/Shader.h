...
#include "VisionRendering/Resources/UniformInfo.h"
...
namespace VisionRendering::Resources
{
	...
	*/
	...
	public:
		...
		* @param p_vec2
		*/
		void SetUniformVec2(const std::string& p_name, const VisionMaths::FVector2& p_vec2);
		...
		* @param p_vec3
		*/
		void SetUniformVec3(const std::string& p_name, const VisionMaths::FVector3& p_vec3);
		...
		* @param p_vec4
		*/
		void SetUniformVec4(const std::string& p_name, const VisionMaths::FVector4& p_vec4);
		...
		* @param p_mat4
		*/
		void SetUniformMat4(const std::string& p_name, const VisionMaths::FMatrix4& p_mat4);
		...
		* @param p_name
		*/
		VisionMaths::FVector2 GetUniformVec2(const std::string& p_name);

		/**
		* Returns the vec3 uniform value identified by the given name
		* @param p_name
		*/
		VisionMaths::FVector3 GetUniformVec3(const std::string& p_name);

		/**
		* Returns the vec4 uniform value identified by the given name
		* @param p_name
		*/
		VisionMaths::FVector4 GetUniformVec4(const std::string& p_name);

		/**
		* Returns the mat4 uniform value identified by the given name
		* @param p_name
		*/
		VisionMaths::FMatrix4 GetUniformMat4(const std::string& p_name);
