...
VisionEditor::Panels::HardwareInfo::HardwareInfo
(
	...
	m_hardwareInfo(new VisionAnalytics::Hardware::HardwareInfo(m_logFrequency))
{
...
void VisionEditor::Panels::HardwareInfo::Update(float p_deltaTime)
{
	m_hardwareInfo->Tick();
	...
	{
		VisionAnalytics::Hardware::HardwareReport report = m_hardwareInfo->GenerateReport();
