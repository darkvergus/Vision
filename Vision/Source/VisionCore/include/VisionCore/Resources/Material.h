...
namespace VisionCore::Resources
{
	...
	*/
	...
	public:
		...
		* @param p_shader
		*/
		void SetShader(VisionRendering::Resources::Shader* p_shader);
		...
		*/
		void Bind(VisionRendering::Resources::Texture* p_emptyTexture);
		...
		*/
		VisionRendering::Resources::Shader*& GetShader();
...
#include "VisionCore/Resources/Material.inl"