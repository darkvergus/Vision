...
void VisionUI::Modules::Canvas::Draw()
{
	if (!m_panels.empty())
	{
...
void VisionUI::Modules::Canvas::AddPanel(Panels::APanel & p_panel)
{
	m_panels.push_back(std::ref(p_panel));
}

void VisionUI::Modules::Canvas::RemovePanel(Panels::APanel & p_panel)
{
...
void VisionUI::Modules::Canvas::RemoveAllPanels()
{
	m_panels.clear();
}

void VisionUI::Modules::Canvas::MakeDockspace(bool p_state)
{
	m_isDockspace = p_state;
}

bool VisionUI::Modules::Canvas::IsDockspace() const
{
