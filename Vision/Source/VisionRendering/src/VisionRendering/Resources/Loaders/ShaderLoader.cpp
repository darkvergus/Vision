...
std::string VisionRendering::Resources::Loaders::ShaderLoader::__FILE_TRACE;

VisionRendering::Resources::Shader* VisionRendering::Resources::Loaders::ShaderLoader::Create(const std::string& p_filePath)
{
...
VisionRendering::Resources::Shader* VisionRendering::Resources::Loaders::ShaderLoader::CreateFromSource(const std::string& p_vertexShader, const std::string& p_fragmentShader)
{
...
void VisionRendering::Resources::Loaders::ShaderLoader::Recompile(Shader& p_shader, const std::string& p_filePath)
{
	__FILE_TRACE = p_filePath;
...
bool VisionRendering::Resources::Loaders::ShaderLoader::Destroy(Shader*& p_shader)
{
	if (p_shader)
	{
		delete p_shader;
...
std::pair<std::string, std::string> VisionRendering::Resources::Loaders::ShaderLoader::ParseShader(const std::string& p_filePath)
{
...
uint32_t VisionRendering::Resources::Loaders::ShaderLoader::CreateProgram(const std::string& p_vertexShader, const std::string& p_fragmentShader)
{
...
uint32_t VisionRendering::Resources::Loaders::ShaderLoader::CompileShader(uint32_t p_type, const std::string& p_source)
{
