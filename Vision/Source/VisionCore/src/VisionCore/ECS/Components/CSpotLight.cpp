...
VisionCore::ECS::Components::CSpotLight::CSpotLight(ECS::Actor & p_owner) :
	CLight(p_owner)
{
	m_data.type = static_cast<float>(VisionRendering::Entities::Light::Type::SPOT);
}

std::string VisionCore::ECS::Components::CSpotLight::GetName()
{
	return "Spot Light";
}

float VisionCore::ECS::Components::CSpotLight::GetConstant() const
{
	return m_data.constant;
}

float VisionCore::ECS::Components::CSpotLight::GetLinear() const
{
	return m_data.linear;
}

float VisionCore::ECS::Components::CSpotLight::GetQuadratic() const
{
	return m_data.quadratic;
}

float VisionCore::ECS::Components::CSpotLight::GetCutoff() const
{
	return m_data.cutoff;
}

float VisionCore::ECS::Components::CSpotLight::GetOuterCutoff() const
{
	return m_data.outerCutoff;
}

void VisionCore::ECS::Components::CSpotLight::SetConstant(float p_constant)
{
	m_data.constant = p_constant;
}

void VisionCore::ECS::Components::CSpotLight::SetLinear(float p_linear)
{
	m_data.linear = p_linear;
}

void VisionCore::ECS::Components::CSpotLight::SetQuadratic(float p_quadratic)
{
	m_data.quadratic = p_quadratic;
}

void VisionCore::ECS::Components::CSpotLight::SetCutoff(float p_cutoff)
{
	m_data.cutoff = p_cutoff;
}

void VisionCore::ECS::Components::CSpotLight::SetOuterCutoff(float p_outerCutoff)
{
	m_data.outerCutoff = p_outerCutoff;
}

void VisionCore::ECS::Components::CSpotLight::OnSerialize(tinyxml2::XMLDocument & p_doc, tinyxml2::XMLNode * p_node)
{
...
void VisionCore::ECS::Components::CSpotLight::OnDeserialize(tinyxml2::XMLDocument & p_doc, tinyxml2::XMLNode * p_node)
{
	using namespace VisionCore::Helpers;
...
void VisionCore::ECS::Components::CSpotLight::OnInspector(VisionUI::Internal::WidgetContainer& p_root)
{
	using namespace VisionCore::Helpers;
