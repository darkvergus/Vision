...
namespace VisionCore::SceneSystem
{
	/**
	...
	*/
	...
	public:
		VisionTools::Eventing::Event<> SceneLoadEvent;
		VisionTools::Eventing::Event<> SceneUnloadEvent;
		VisionTools::Eventing::Event<const std::string&> CurrentSceneSourcePathChangedEvent;
