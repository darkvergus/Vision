#include "VisionUI/Widgets/Selection/ColorPicker.h"

VisionUI::Widgets::Selection::ColorPicker::ColorPicker(bool p_enableAlpha, const Types::Color & p_defaultColor) :
	DataWidget<Types::Color>(color), enableAlpha(p_enableAlpha), color(p_defaultColor)
{
}

void VisionUI::Widgets::Selection::ColorPicker::_Draw_Impl()
{
