...
bool											VisionAnalytics::Profiling::Profiler::__ENABLED;
std::mutex										VisionAnalytics::Profiling::Profiler::__SAVE_MUTEX;
std::unordered_map<std::string, double>			VisionAnalytics::Profiling::Profiler::__ELPASED_HISTORY;
std::unordered_map<std::string, uint64_t>		VisionAnalytics::Profiling::Profiler::__CALLS_COUNTER;
std::vector<std::thread::id>					VisionAnalytics::Profiling::Profiler::__WORKING_THREADS;
uint32_t										VisionAnalytics::Profiling::Profiler::__ELAPSED_FRAMES;

VisionAnalytics::Profiling::Profiler::Profiler()
{
	m_lastTime = std::chrono::high_resolution_clock::now();
	__ENABLED = false;
}

VisionAnalytics::Profiling::ProfilerReport VisionAnalytics::Profiling::Profiler::GenerateReport()
{
...
void VisionAnalytics::Profiling::Profiler::ClearHistory()
{
...
void VisionAnalytics::Profiling::Profiler::Update(float p_deltaTime)
{
	if (IsEnabled())
	{
		++__ELAPSED_FRAMES;
...
void VisionAnalytics::Profiling::Profiler::Save(VisionAnalytics::Profiling::ProfilerSpy& p_spy)
{
	__SAVE_MUTEX.lock();
...
bool VisionAnalytics::Profiling::Profiler::IsEnabled()
{
	return __ENABLED;
}

void VisionAnalytics::Profiling::Profiler::ToggleEnable()
{
	__ENABLED = !__ENABLED;
}

void VisionAnalytics::Profiling::Profiler::Enable()
{
	__ENABLED = true;
}

void VisionAnalytics::Profiling::Profiler::Disable()
{
	__ENABLED = false;
}