...
#include "VisionUI/Widgets/Sliders/ESliderOrientation.h"
#include "VisionUI/Internal/Converter.h"

namespace VisionUI::Widgets::Sliders
{
	/**
	...
	*/
	...
	public:
		...
		VisionMaths::FVector2 verticalModeSize; /* Only applied with ESliderOrientation::VERTICAL */
		std::string label;
		std::string format;
		VisionTools::Eventing::Event<T> ValueChangedEvent;
