...
uint32_t Pack(const VisionMaths::FVector3& p_toPack)
{
...
VisionRendering::Entities::Light::Light(VisionMaths::FTransform & p_tranform, Type p_type) : m_transform(p_tranform), type(static_cast<float>(p_type))
{
	
}

VisionMaths::FMatrix4 VisionRendering::Entities::Light::GenerateMatrix() const
{
	VisionMaths::FMatrix4 result;
...
float CalculateAmbientBoxLightRadius(const VisionMaths::FVector3& p_position, const VisionMaths::FVector3& p_size)
{
	return VisionMaths::FVector3::Distance(p_position, p_position + p_size);
}

float VisionRendering::Entities::Light::GetEffectRange() const
{
	switch (static_cast<VisionRendering::Entities::Light::Type>(static_cast<int>(type)))
	{
	case Type::POINT:
...
const VisionMaths::FTransform& VisionRendering::Entities::Light::GetTransform() const
{
	return m_transform;
}
