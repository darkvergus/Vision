...
#include "VisionWindowing/Inputs/EKey.h"
#include "VisionWindowing/Inputs/EKeyState.h"
#include "VisionWindowing/Inputs/EMouseButton.h"
#include "VisionWindowing/Inputs/EMouseButtonState.h"

namespace VisionWindowing::Inputs
{
	/**
	...
	*/
	...
	private:
		...
		VisionTools::Eventing::ListenerID m_keyPressedListener;
		VisionTools::Eventing::ListenerID m_keyReleasedListener;
		VisionTools::Eventing::ListenerID m_mouseButtonPressedListener;
		VisionTools::Eventing::ListenerID m_mouseButtonReleasedListener;
