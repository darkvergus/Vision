...
VisionAudio::Core::AudioEngine::AudioEngine(const std::string & p_workingDirectory) : m_workingDirectory(p_workingDirectory)
{
	m_irrklangEngine = irrklang::createIrrKlangDevice();

	using AudioSourceReceiver	= void(AudioEngine::*)(VisionAudio::Entities::AudioSource&);
	using AudioListenerReceiver = void(AudioEngine::*)(VisionAudio::Entities::AudioListener&);
...
VisionAudio::Core::AudioEngine::~AudioEngine()
{
	m_irrklangEngine->drop();
}

void VisionAudio::Core::AudioEngine::Update()
{
	...
	std::optional<std::pair<VisionMaths::FVector3, VisionMaths::FVector3>> listener = GetListenerInformation();
...
void VisionAudio::Core::AudioEngine::Suspend()
{
...
void VisionAudio::Core::AudioEngine::Unsuspend()
{
...
bool VisionAudio::Core::AudioEngine::IsSuspended() const
{
	return m_suspended;
}

const std::string& VisionAudio::Core::AudioEngine::GetWorkingDirectory() const
{
	return m_workingDirectory;
}

irrklang::ISoundEngine * VisionAudio::Core::AudioEngine::GetIrrklangEngine() const
{
	return m_irrklangEngine;
}

std::optional<std::pair<VisionMaths::FVector3, VisionMaths::FVector3>> VisionAudio::Core::AudioEngine::GetListenerInformation(bool p_considerDisabled) const
{
...
void VisionAudio::Core::AudioEngine::Consider(VisionAudio::Entities::AudioSource & p_audioSource)
{
	m_audioSources.push_back(std::ref(p_audioSource));
}

void VisionAudio::Core::AudioEngine::Consider(VisionAudio::Entities::AudioListener & p_audioListener)
{
	m_audioListeners.push_back(std::ref(p_audioListener));
}

void VisionAudio::Core::AudioEngine::Unconsider(VisionAudio::Entities::AudioSource & p_audioSource)
{
...
void VisionAudio::Core::AudioEngine::Unconsider(VisionAudio::Entities::AudioListener & p_audioListener)
{
