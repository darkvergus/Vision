...
VisionWindowing::Inputs::InputManager::InputManager(Window& p_window) : m_window(p_window)
{
...
VisionWindowing::Inputs::InputManager::~InputManager()
{
...
VisionWindowing::Inputs::EKeyState VisionWindowing::Inputs::InputManager::GetKeyState(EKey p_key) const
{
...
VisionWindowing::Inputs::EMouseButtonState VisionWindowing::Inputs::InputManager::GetMouseButtonState(EMouseButton p_button) const
{
...
bool VisionWindowing::Inputs::InputManager::IsKeyPressed(EKey p_key) const
{
	return m_keyEvents.find(p_key) != m_keyEvents.end() && m_keyEvents.at(p_key) == EKeyState::KEY_DOWN;
}

bool VisionWindowing::Inputs::InputManager::IsKeyReleased(EKey p_key) const
{
	return m_keyEvents.find(p_key) != m_keyEvents.end() && m_keyEvents.at(p_key) == EKeyState::KEY_UP;
}

bool VisionWindowing::Inputs::InputManager::IsMouseButtonPressed(EMouseButton p_button) const
{
...
bool VisionWindowing::Inputs::InputManager::IsMouseButtonReleased(EMouseButton p_button) const
{
...
std::pair<double, double> VisionWindowing::Inputs::InputManager::GetMousePosition() const
{
...
void VisionWindowing::Inputs::InputManager::ClearEvents()
{
	m_keyEvents.clear();
	m_mouseButtonEvents.clear();
}

void VisionWindowing::Inputs::InputManager::OnKeyPressed(int p_key)
{
	m_keyEvents[static_cast<EKey>(p_key)] = EKeyState::KEY_DOWN;
}

void VisionWindowing::Inputs::InputManager::OnKeyReleased(int p_key)
{
	m_keyEvents[static_cast<EKey>(p_key)] = EKeyState::KEY_UP;
}

void VisionWindowing::Inputs::InputManager::OnMouseButtonPressed(int p_button)
{
	m_mouseButtonEvents[static_cast<EMouseButton>(p_button)] = EMouseButtonState::MOUSE_DOWN;
}

void VisionWindowing::Inputs::InputManager::OnMouseButtonReleased(int p_button)
{
