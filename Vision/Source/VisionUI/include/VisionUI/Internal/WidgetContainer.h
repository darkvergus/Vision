...
#include "VisionUI/Internal/EMemoryMode.h"
...
namespace VisionUI::Internal
{
	...
	*/
	...
	public:
		...
		*/
		std::vector<std::pair<VisionUI::Widgets::AWidget*, Internal::EMemoryMode>>& GetWidgets();

	protected:
		std::vector<std::pair<VisionUI::Widgets::AWidget*, Internal::EMemoryMode>> m_widgets;
