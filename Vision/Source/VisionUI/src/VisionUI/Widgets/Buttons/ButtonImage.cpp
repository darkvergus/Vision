...
VisionUI::Widgets::Buttons::ButtonImage::ButtonImage(uint32_t p_textureID, const VisionMaths::FVector2 & p_size) :
	textureID{ p_textureID }, size(p_size)
{
}

void VisionUI::Widgets::Buttons::ButtonImage::_Draw_Impl()
{
