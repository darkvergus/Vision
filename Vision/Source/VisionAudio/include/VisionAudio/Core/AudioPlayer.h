...
namespace VisionAudio::Core
{
	...
	*/
	...
	public:
		...
		* @param p_track
		*/
		std::unique_ptr<Tracking::SoundTracker> PlaySpatialSound(const Resources::Sound& p_sound, bool p_autoPlay = true, bool p_looped = false, const VisionMaths::FVector3& p_position = {0.0f, 0.0f, 0.0f}, bool p_track = false);
