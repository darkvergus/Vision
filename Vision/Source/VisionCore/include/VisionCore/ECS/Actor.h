...
namespace VisionCore::ECS
{
	...
	*/
	...
	public:
		...
		* @param p_component
		*/
		bool RemoveComponent(VisionCore::ECS::Components::AComponent& p_component);
	...
	public:
		...
		VisionTools::Eventing::Event<Components::AComponent&>	ComponentAddedEvent;
		VisionTools::Eventing::Event<Components::AComponent&>	ComponentRemovedEvent;
		VisionTools::Eventing::Event<Components::Behaviour&>	BehaviourAddedEvent;
		VisionTools::Eventing::Event<Components::Behaviour&>	BehaviourRemovedEvent;

		/* Some events that are triggered when an action occur on any actor */
		static VisionTools::Eventing::Event<Actor&>				DestroyedEvent;
		static VisionTools::Eventing::Event<Actor&>				CreatedEvent;
		static VisionTools::Eventing::Event<Actor&, Actor&>		AttachEvent;
		static VisionTools::Eventing::Event<Actor&>				DettachEvent;
...
#include "VisionCore/ECS/Actor.inl"