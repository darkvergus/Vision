...
#include "VisionWindowing/Dialogs/FileDialog.h"

VisionWindowing::Dialogs::FileDialog::FileDialog(std::function<int(tagOFNA*)> p_callback, const std::string & p_dialogTitle) :
...
void VisionWindowing::Dialogs::FileDialog::SetInitialDirectory(const std::string & p_initialDirectory)
{
	m_initialDirectory = p_initialDirectory;
}

void VisionWindowing::Dialogs::FileDialog::Show(EExplorerFlags p_flags)
{
	OPENFILENAME ofn;
...
bool VisionWindowing::Dialogs::FileDialog::HasSucceeded() const
{
	return m_succeeded;
}

std::string VisionWindowing::Dialogs::FileDialog::GetSelectedFileName()
{
	return m_filename;
}

std::string VisionWindowing::Dialogs::FileDialog::GetSelectedFilePath()
{
	return m_filepath;
}

std::string VisionWindowing::Dialogs::FileDialog::GetErrorInfo()
{
	return m_error;
}

bool VisionWindowing::Dialogs::FileDialog::IsFileExisting() const
{
	return std::filesystem::exists(m_filepath);
}

void VisionWindowing::Dialogs::FileDialog::HandleError()
{
