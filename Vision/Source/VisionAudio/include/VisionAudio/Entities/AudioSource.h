...
namespace VisionAudio::Core { class AudioPlayer; }
...
namespace VisionAudio::Entities
{
	...
	*/
	...
	public:
		...
		* @param p_transform
		*/
		AudioSource(Core::AudioPlayer& p_audioPlayer, VisionMaths::FTransform& p_transform);
	...
	public:
		static VisionTools::Eventing::Event<AudioSource&> CreatedEvent;
		static VisionTools::Eventing::Event<AudioSource&> DestroyedEvent;
