...
namespace VisionCore::ECS::Components
{
	...
	*/
	...
	public:
		static VisionTools::Eventing::Event<Behaviour*> CreatedEvent;
		static VisionTools::Eventing::Event<Behaviour*> DestroyedEvent;
...
#include "VisionCore/ECS/Components/Behaviour.inl"