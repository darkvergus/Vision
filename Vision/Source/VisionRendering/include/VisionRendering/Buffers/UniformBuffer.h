...
namespace VisionRendering::Buffers
{
	...
	*/
	...
	public:
		...
		*/
		static void BindBlockToShader(VisionRendering::Resources::Shader& p_shader, uint32_t p_uniformBlockLocation, uint32_t p_bindingPoint = 0);
		...
		* @param p_bindingPoint
		*/
		static void BindBlockToShader(VisionRendering::Resources::Shader& p_shader, const std::string& p_name, uint32_t p_bindingPoint = 0);
		...
		* @param p_name
		*/
		static uint32_t GetBlockLocation(VisionRendering::Resources::Shader& p_shader, const std::string& p_name);
...
#include "VisionRendering/Buffers/UniformBuffer.inl"