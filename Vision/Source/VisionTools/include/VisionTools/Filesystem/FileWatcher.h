...
namespace VisionTools::Filesystem
{
	/**
	...
	*/
	...
	public:
		VisionTools::Eventing::Event<std::string> FileAddedEvent;
		VisionTools::Eventing::Event<std::string> FileChangedEvent;
		VisionTools::Eventing::Event<std::string> FileDeletedEvent;
